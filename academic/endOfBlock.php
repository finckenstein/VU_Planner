<?php
  ...
  $sql = "SELECT * FROM assignment WHERE submitted = '0' AND deadline BETWEEN CURDATE() AND '2020-07-05' ORDER BY deadline ASC;";
...
<head>
  <title>End of Block toDo List</title>
</head>

<body>
  <h1>End of Block toDo List</h1>
